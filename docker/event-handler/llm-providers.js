...
export const BUILTIN_PROVIDERS = {
  ...
  openai: {
    ...
    credentials: [{ type: "api_key", key: "OPENAI_API_KEY", label: "API Key" }],
    models: [
  ...
  google: {
    ...
    credentials: [{ type: "api_key", key: "GOOGLE_API_KEY", label: "API Key" }],
    models: [
  ...
  xai: {
    ...
    litellmProxy: true,
    litellmPrefix: "xai",
    credentials: [{ type: "api_key", key: "XAI_API_KEY", label: "API Key" }],
    models: [
