...
function ChatInput({
  ...
  const handleSubmit = (e) => {
    ...
    if (disabled || !input.trim() && !partialText.trim() && files.length === 0 || isStreaming)
      return;
  ...
  if (disabled && !isStreaming) {
    const disabledContent = /* @__PURE__ */ jsx(
      "div",
      {
        className: cn(
        ...
        children: /* @__PURE__ */ jsx("div", { className: "flex items-center px-2 py-1.5", children: /* @__PURE__ */ jsx("span", { className: "text-sm text-muted-foreground", children: placeholder }) })
      }
    );
          ...
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1", children: [
            ...
            codeModeSettings && !codeModeSettings.isInteractiveActive && /* @__PURE__ */ jsxs(
              "button",
              {
                ...
                children: [
                  codeModeSettings.togglingMode && /* @__PURE__ */ jsxs(
                    "svg",
                    {
