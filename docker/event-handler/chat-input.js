...
function ChatInput({ input, setInput, onSubmit, status, stop, files, setFiles, disabled = false, placeholder = "Send a message...", canSendOverride, bare = false, className }) {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1", children: [
            ...
            voiceAvailable && /* @__PURE__ */ jsx(VoiceBars, { volumeRef, isRecording }),
            /* @__PURE__ */ jsx(
              "input",
              {
                ref: fileInputRef,
          ...
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1", children: [
            ...
            voiceAvailable && !isStreaming && /* @__PURE__ */ jsx(
              "button",
              {
                ...
                className: cn(
                  "inline-flex items-center justify-center rounded-lg p-2.5",
                  isConnecting ? "bg-muted-foreground/20 text-muted-foreground cursor-wait animate-pulse" : isRecording ? "bg-red-500 text-white hover:opacity-80" : "bg-foreground text-background hover:opacity-80"
                ),
